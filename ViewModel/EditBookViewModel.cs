...
namespace Library_wpf.ViewModel
{
    public class EditBookViewModel : BaseViewModel
    {
        ...
        public EditBookViewModel(IBookDB bookDB, IAuthorDB authorDB, IGenreDB genreDB, Book selectedBook, MainViewModel mainViewModel) 
        {
            _bookDB = bookDB;
            _authorDB = authorDB;
            _genreDB = genreDB;
        ...
        public async void SaveCommandMethod()
        {
            Book book = new Book();
            book.Name = NameText;
            book.Author = (SelectedBookAuthor).Name;
            book.Genre = (SelectedBookGenre).Name;
            int result;
        ...
        public async Task GetAuthors()
        {
            ...
            Book oldBook = SelectedBook;
            Author bookAuthor = new Author();
            bookAuthor.Name = (SelectedBook).Author;
        ...
        public async Task GetGenres()
        {
            ...
            bookGenre.Name = (SelectedBook).Genre;
