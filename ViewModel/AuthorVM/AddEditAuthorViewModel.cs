...
{
    public class AddEditAuthorViewModel : BaseViewModel
    {
        ...
        public AddEditAuthorViewModel(IAuthorDB authorDB, MainViewModel mainViewModel)
        {
            _authorDB = authorDB;
            _mainViewModel = mainViewModel;
        }
        public AddEditAuthorViewModel(IAuthorDB authorDB, MainViewModel mainViewModel, Author selectedAuthor) 
        {
            _authorDB = authorDB;
            _mainViewModel = mainViewModel;
